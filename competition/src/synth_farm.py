...
## 무엇을 실측에서 가져오고 무엇을 가정하는가
  ...
  실측  재귀발정일 · 분만율 · 복당이유 · 임신/포유기간 · 계절 변동(−2.97%p) ·
        임신사고 유형 구성(1차 35.3% · 불규칙 19.9% · 2차 11.7% …)
