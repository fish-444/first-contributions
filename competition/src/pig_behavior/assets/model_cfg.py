...
optim_wrapper = dict(
    loss_scale='dynamic',
    optimizer=dict(lr=0.000756, momentum=0.9, type='SGD', weight_decay=0.0001),
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='label/test_2.json',
        backend_args=None,
        data_prefix=dict(img='01/'),
        data_root='/storage/',
        metainfo=dict(
            classes=(
                'Scrubbing',
...
test_evaluator = dict(
    ann_file='/storage/label/test_2.json',
    backend_args=None,
    metric=[
        'bbox',
        'segm',
...
work_dir = './work_dirs/mask-rcnn_x101-64x4d_fpn_ms-poly_3x_coco'
